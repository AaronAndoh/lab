...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title> Brand AaronVisuals</title>
...
<body class="is-boxed has-animations">
    <div class="body-wrap boxed-container">
		...
		<div class="hero-cta" id="cat"><a class="button button-shadow" href="category.php">Category</a></div>
		<div class="hero-cta" id="cat"><a class="button button-shadow" href="product.php">Product</a></div>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">AaronVisuals Brands</h1>
	                        <div class="hero-copy">
							<form action="../actions/add_brand.php" method="POST">

							<?php
									// get the get info from the link
									$id_info = $_GET['brand_id'];

									//get one brand based of the id
									$get_one = get_one_brand_ctrl($id_info);
									...
									$name = $_POST['brand_1'];
										...
										//update controller
									$update_check = update_brand_ctr($name,$id_info);
...
?>
								<label>Enter brand Name: </label><br><br>
								<input type="text" name="brand" class="brand_text">
                                <input type="hidden" name="brand_update_id" class="brand_text_id" value="<?php echo $get_one['brand_id'] ?>" >
	                        ...
	                        <div class="hero-cta"><a class="button button-shadow" href="../Admin/edit_brand.php">View Brands</a>
						
	                        	<button a class="button button-primary button-shadow" type="submit" name="brand_button">Add Brand</a></button></form><br><br>
								<form method="Post">
								
								<label>Enter Updated brand Name: </label><br><br>
								<input type="text" name="brand_1" class="brand_text" value="<?php echo $get_one['brand_name'] ?>"><br><br>
						<button a class="button button-primary button-shadow" type="submit" name="brand_update">Update Brand</a></button>
