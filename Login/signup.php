                ...
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
							...
							<h1 class="hero-title mt-0">Register An Account</h1>
	                        <div class="hero-copy">
							<form action="../actions/register_proc.php" method="POST">

								<label>Name</label><br>
								<input type="text" name="Name_signup"><br><br>

								<label>Email</label><br>
								<input type="Email" name="email_signup"><br><br>

								<label>Password</label><br><br>
								<input type="password" name="Password_signup" id="Password_signup" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required><br><br>
								...
								<input type="text" name="country_signup"><br><br>

								<label>City</label><br>
								<input type="text" name="city_signup"><br><br>

								<label>Contact</label><br>
								<input type="tel" name="contact_signup" ><br><br>

								<label>Upload Image</label><br>
								<input a class="button button-shadow" type="file" name="image_signup"><br><br>
