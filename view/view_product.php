...
<body class="is-boxed has-animations">
    <div class="body-wrap boxed-container">
        ...
        <main>
            <section class="hero">
			<div class="hero-cta" id="logout"><a class="button button-shadow" href="../actions/logout.php">Log out</a>
			<a class="button button-shadow" href="../index.php">Back</a>
                ...
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
							...
							<h1 class="hero-title mt-0">PRODUCTS AVALIABLE</h1>
	                        <div class="hero-copy">
                          <table class="table">
                    <thead>
                      <tr>
                        <th a style="color: white"; scope="col">ID</th>
                        <th a style="color: white"; scope="col">Product category</th>
                        <th a style="color: white"; scope="col">Product brand</th>
                        <th a style="color: white"; scope="col">Product title</th>
                        <th a style="color: white"; scope="col">Product price</th>
                        <th a style="color: white"; scope="col">Product description</th>
                        <th a style="color: white"; scope="col">Product keywords</th>
                        <th a style="color: white"; scope="col"> </th>
                        <th a style="color: white"; scope="col"> </th>
                      </tr>
                    </thead>
                    <tbody> 
						...
						//accessing the controllerfor getting all the brand
                          $product_items = get_all_products_ctr();

						  //for each  to make a loop to display all the items in the brand 
                          foreach ($product_items as $product) {
                        ?>
                          <tr>
                            <td a style="color: white" scope="row"><?php echo $product["product_id"] ?></td>
                            <td a style="color: white" ><?php echo $product["product_cat"] ?></td>
                            <td a style="color: white" ><?php echo $product["product_brand"] ?></td>
                            <td a style="color: white" ><?php echo $product["product_title"] ?></td>
                            <td a style="color: white" ><?php echo $product["product_price"] ?></td>
                            <td a style="color: white" ><?php echo $product["product_desc"] ?></td>
                            <td a style="color: white" ><?php echo $product["product_keywords"] ?></td>
                            <td>
                      <form action="../admin/edit_product.php" method="Get">
                        <input type="hidden" name="product_id" value='<?php echo $product["product_id"] ?>'>

                        <button  a class="button button-primary button-shadow"type="submit" name="edit_product">Edit</button>
                      ...
                      <input type="hidden" name="product_id" value='<?php echo $product["product_id"] ?>'>
                        <button  a class="button button-primary button-shadow"type="submit"  name="product_brand">Delete</button>
                      </form>
                      </td>
                      </tr>
                    <?php } ?>
	                        ...
	                        <!-- <div class="hero-cta"><a class="button button-shadow" href="../login/login.php">Log in</a>
	                        	<button a class="button button-primary button-shadow" type="submit" name="Signup_button">Sign up</a></button>
	                        </div> -->
						</div>
						</form>
						...
						<div class="hero-app">
							...
							<!-- <img class="device-mockup" src="../images/Black & White 1.png" alt="App preview"> -->
