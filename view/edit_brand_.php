                    ...
                    <div class="hero-inner">
						<div class="hero-copy">
							...
							<form method="POST">
								...
								<input type="text" name="brand_update" class="brand_text" value="<?php echo $get_one['brand_name'] ?>">
...
<!-- 	                        <p class="hero-paragraph">Homes of all kinds of artworks.</p> -->
	                        <div class="hero-cta"><a class="button button-shadow" href="../view/edit_brand.php">View Brand</a>
	                        	<button a class="button button-primary button-shadow" type="submit" name="brand_button">Update Brand</a></button>
	                        </div>
						</div>
						</form>
