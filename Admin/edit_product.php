...
<body class="is-boxed has-animations">
    <div class="body-wrap boxed-container">
		...
		<div class="hero-cta" id="logout"><a class="button button-shadow" href="../actions/logout.php">Log out</a></div>
                ...
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
							...
							<h1 class="hero-title mt-0">AaronVisuals Product</h1>
	                        <div class="hero-copy">
                                ...
                                <?php // endif ?> -->
                                <?php
									// get the get info from the link
									$id_info = $_GET['product_id'];

									//get one product based of the id
									$get_one = get_one_product_ctr($id_info);
									
									//start a server got the post
									if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                        

										//getting info from the textbox
                                   ...
                                   // echo "$img_name";
                                    ...
                                    $folder=file_Upload("images","products",$tmp_name,$img_name);
										...
										//update controller
									$update_check = update_product_ctr($cat_name,$b_name,$p_title,$p_price,$p_desc,$folder,$p_keywords,$id_info);
									
									//checking the if the update controller woeks
										if($update_check){

											//redirects to edit_brand
...
?>
								...
								<select name="cat_name" id="cat_name" style="width: 400px;">
                                        <?php
                                        //run to get all course function
                                        $catitem = get_all_cat_ctr();
								...
								<select name="product_brand" id="product_brand"  value="<?php echo $get_one['product_brand']?>" style="width: 400px;">
                                        <?php
                                        //run to get all course function
                                        $branditem = get_all_brands_ctr();

                                        //check if anything was returned
                                        if ($branditem) {
                                            //course Found
                                            foreach ($branditem as $one_brand) {
								...
								<input type="text" name="product_title" id="product_title"  style="width: 400px;"  value="<?php echo $get_one['product_title']?>"><br><br>
				
								<label>Product Price</label><br>
                                <input type="number" name="product_price" step="0.1"  value="<?php echo $get_one['product_price']?>" style="width: 400px;" >
								<br><br>

								<label>Product Description</label><br>
								<input type="text" name="product_description" style="width: 400px;"  value="<?php echo $get_one['product_desc']?>" ><br><br>

								<label>Upload Product Image</label><br>
								<input type="file" name="Product_image" a class="button button-shadow"  value="<?php echo $get_one['product_image']?>"style="width: 400px;"><br><br>

                                <label>Product Keywords</label><br>
								<input type="text" name="product_keywords" style="width: 400px;" value="<?php echo $get_one['product_keywords']?>"><br><br>

                            
						</div>
	                        <div class="hero-cta">
	                        	<button a class="button button-primary button-shadow" type="submit" name="product_add">Add Product</a></button><br><br>
                                    </form>
