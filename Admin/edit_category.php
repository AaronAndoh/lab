...
<body class="is-boxed has-animations">
    <div class="body-wrap boxed-container">
        ...
        <main>
            ...
            <div class="hero-cta" id="logout"><a class="button button-shadow" href="category.php">Add Category</a></div>

                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                    
							<h1 class="hero-title mt-0">CATEGORIES AVALIABLE</h1>
	                        <div class="hero-copy">
                          <table class="table">
                    <thead>
                      <tr>
                        <th a style="color: white"; scope="col">ID</th>
                        <th a style="color: white"; scope="col">Categories Name</th>
                    ...
                    <tbody> 
						...
						//accessing the controllerfor getting all the brand
                          $cat_items = get_all_cat_ctr();

						  //for each  to make a loop to display all the items in the brand 
                          foreach ($cat_items as $cat) {
                        ?>
                          <tr>
                            <th a style="color: white" scope="row"><?php echo $cat["cat_id"] ?></th>
                            <td a style="color: white" ><?php echo $cat["cat_name"] ?></td>
                            <td>
                      <form action="category.php" method="Get">
                        ...
                        <button  a class="button button-primary button-shadow"type="submit"  name="edit_cat">Edit</button>
                      ...
                      <input type="hidden" name="cat_id" value='<?php echo $cat["cat_id"] ?>'>
                        <input type="hidden" name="cat_name" value='<?php echo $cat["cat_name"] ?>'>
                        <button  a class="button button-primary button-shadow"type="submit"  name="delete_cat">Delete</button>
                      </form>
                      </td>
                      </tr>
                    <?php } ?>
