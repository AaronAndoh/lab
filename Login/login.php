            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Login into your Account</h1>
<!------------------------------------------------------Login forms-------------------------------------------------------------------------------------------------------------------------->
	                        <div class="hero-copy">
							<form action="../actions/login_proc.php" method="POST" onsubmit = "return verifyPassword()">
								<label>Email</label><br>
								<input type="Email" name="email_login" id="email_login"><br><br>

								<label>Password</label><br>
								<input type="password" name="Password_login" id="Password_login" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
								<span id = "message1" style="color:red"></span> <br><br>
							
						</div>
	                        <div class="hero-cta"><button a class="button button-shadow" name="Login_btn">Log in</a></button>
	                        	<a class="button button-primary button-shadow" href="../Login/signup.php">Sign up</a></div>
						</div>
						</form>
<!---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
