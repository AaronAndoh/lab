...
<body class="is-boxed has-animations">
    <div class="body-wrap boxed-container">
        ...
        <div class="hero-cta" id="brand"><a class="button button-shadow" href="brand.php">Brand</a></div>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">AaronVisuals Category</h1>
	                        <div class="hero-copy">
							...
							<?php
									...
									$get_one = get_one_cat_ctr($id_info);
									...
									$name = $_POST['cat_1'];
										...
										//update controller
									$update_check = update_cat_ctr($name,$id_info);
...
?>
								...
								<input type="text" name="category" class="category_text">
	                        ...
	                        <div class="hero-cta"><a class="button button-shadow" href="edit_category.php">View category</a>
						
	                        	<button a class="button button-primary button-shadow" type="submit" name="category_add">Add Category</a></button></form><br><br>
								<form method="Post">
								
								<label>Enter Updated brand Name: </label><br><br>
								<input type="text" name="cat_1" class="cat_text" value="<?php echo $get_one['cat_name'] ?>"><br><br>
                                <input type="hidden" name="cat_update_id"  class="brand_text_id"  value="<?php echo $get_one['cat_id']?>">
                             
						<button a class="button button-primary button-shadow" type="submit" name="cat_update">Update Brand</a></button>
