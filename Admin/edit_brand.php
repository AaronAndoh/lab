                ...
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
							...
							<h1 class="hero-title mt-0">BRANDS AVALIABLE</h1>
	                        <div class="hero-copy">
                          <table class="table">
                    <thead>
                      <tr>
                        <th a style="color: white"; scope="col">ID</th>
                        <th a style="color: white"; scope="col">Brand Name</th>
                    ...
                    <tbody> 
						...
						//accessing the controllerfor getting all the brand
                          $brand_items = get_all_brands_ctr();

						  //for each  to make a loop to display all the items in the brand 
                          foreach ($brand_items as $brand) {
                        ?>
                          <tr>
                            <td a style="color: white" scope="row"><?php echo $brand["brand_id"] ?></td>
                            <td a style="color: white" ><?php echo $brand["brand_name"] ?></td>
                            <td>
                      <form action="brand.php" method="Get">
                        ...
                        <button  a class="button button-primary button-shadow"type="submit" name="edit_brand">Edit</button>
                       
                      </form>
                      </td>
                      <td>
                      <form action="../actions/edit_delete_brand.php" method="post">
                      <input type="hidden" name="brand_id" value='<?php echo $brand["brand_id"] ?>'>
                        <input type="hidden" name="brand_name" value='<?php echo $brand["brand_name"] ?>'>
                        <button  a class="button button-primary button-shadow"type="submit"  name="delete_brand">Delete</button>
                      </form>
                      </td>
                      </tr>
                    <?php } ?>
