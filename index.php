            ...
            <section class="hero">
                <div class="container">
                    ...
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Welcome To AaronVisuals</h1>
	                        <p class="hero-paragraph">Homes of all kinds of artworks.</p>
	                        <div class="hero-cta"><a class="button button-shadow" href="Login/login.php">Log in</a><a class="button button-primary button-shadow" href="Login/signup.php">Sign up</a>
							<a class="button button-shadow" href="view/product_showing.php">View Product</a></div>
						</div>
						<div class="hero-app">
                        ...
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
									...
									<div class="hero-cta"><a class="button button-shadow" href="actions/logout.php">Log out</a></div>
                                </div>
                            </div>
							<div class="feature is-revealing">
                                <div class="feature-inner">
