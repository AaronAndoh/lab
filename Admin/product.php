...
<body class="is-boxed has-animations">
    <div class="body-wrap boxed-container">
        ...
        <a class="button button-shadow" href="../view/view_product.php">View Product</a>
                    ...
                    <div class="hero-inner">
						<div class="hero-copy">
							...
							<form action="../actions/add_product.php" method="POST" enctype='multipart/form-data'>
								...
								<select name="product_brand" id="product_brand" style="width: 400px;">
                                        <?php
                                        //run to get all course function
								...
								<input type="text" name="product_title" id="product_title"  placeholder="Enter Title" style="width: 400px;" ><br><br>
				
								<label>Product Price</label><br>
                                <input type="number" name="product_price" step="0.1"  style="width: 400px;" >
								<br><br>

								<label>Product Description</label><br>
								<input type="text" name="product_description" style="width: 400px;" ><br><br>

								<label>Upload Product Image</label><br>
								<input type="file" name="Product_image" a class="button button-shadow"  style="width: 400px;"><br><br>

                                <label>Product Keywords</label><br>
								<input type="text" name="product_keywords" style="width: 400px;" ><br><br>
	                        ...
	                        <div class="hero-cta">
	                        	...
	                        	<button a class="button button-primary button-shadow" type="submit" name="product_add">Add Product</a></button><br><br>
                                    ...
                                    <form action="../actions/add_product_brand.php" method="POST">
                                <label>Add product brand</label><br>
								<input type="text" name="brand" style="width: 400px;" ><br><br>

                               

                                <button a class="button button-primary button-shadow" type="submit" name="product_brand_add">Add Product brand</a></button><br><br>
